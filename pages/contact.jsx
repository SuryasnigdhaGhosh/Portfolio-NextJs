...
const Contact = () => {
    ...
    return (
        <BannerLayout>
            <div className="flex justify-between flex-col h-screen px-4 py-2">
                    ...
                    <div className="flex flex-col md:flex-row items-center gap-5 text-xs">
                        <div className="card_stylings w-full md:w-1/2 p-5 md:p-6 lg:p-8 flex flex-col gap-y-4">
                            ...
                            <div className="flex justify-between items-center">
                                ...
                                <span className='text-LightGray md:text-sm'>Lean Platform Technologies</span>
                            </div>
                        </div>
                        <div className="card_stylings rounded-xl w-full md:w-1/2 p-5 md:p-6 lg:p-8 flex flex-col gap-y-4">
                            <div className="flex justify-between items-center">
                                <span className='md:text-base'>Email:</span>
                                <span className='text-LightGray text-sm'>suryasnigdhaghosh@gmail.com</span>
                            </div>
                            <div className="flex justify-between items-center">
                                <span className='md:text-base'>Linkedin:</span>
                                <span onClick={() => window.open("https://www.linkedin.com/in/suryasnigdha-ghosh-393bbb291/")} target='_blank' className='text-LightGray cursor-pointer underline text-sm'>SuryasnigdhaGhosh</span>
                            </div>
                            <div className="flex justify-between items-center">
                                <span className='md:text-base'>Phone:</span>
                                <span className='text-LightGray text-sm'>+91 7439825966</span>
                            </div>
                        </div>
                    </div>
                </div>
                <div className="h-16 w-full card_stylings text-xl sm:text-3xl flex gap-x-8 sm:gap-x-16 items-center justify-center text-Snow">
                    ...
                    <a className='hover:scale-125 ease-in-out duration-700' href="https://github.com/SuryasnigdhaGhosh" target='_blank' rel="noreferrer"><FaGithub /></a>
                    <a className='hover:scale-125 ease-in-out duration-700' href="https://www.linkedin.com/in/suryasnigdha-ghosh-393bbb291/" target='_blank' rel="noreferrer"><FaLinkedin /></a>
                    <a className='hover:scale-125 ease-in-out duration-700' href="https://www.instagram.com/__suryaa_._/" target='_blank' rel="noreferrer"><FaInstagram /></a>
                    <a className='hover:scale-125 ease-in-out duration-700' href="https://wa.me/7998489479" target='_blank' rel="noreferrer"><FaWhatsapp/></a>
